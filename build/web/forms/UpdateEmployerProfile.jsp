<%-- 
    Document   : UpdateEmployerProfile
    Created on : Nov 14, 2018, 1:39:49 PM
    Author     : user
--%>
...
<html>
    ...
    <center><h1>Update Employer Profile</h1></center><br><br>
    ...
    <input type="hidden" name="btnUpdateEmployerDisable" id="btnUpdateEmployerDisable" value="${btnUpdateEmployerDisable}" />
    <script>
        ...
        function disableUpdateBtn() {
            var btnUpdateEmployerDisable = document.getElementById("btnUpdateEmployerDisable").value;

            if (btnUpdateEmployerDisable != "") {
...
<body onload="selectGender();disableUpdateBtn();">
    <form method="POST" action="../UpdateEmployerProfile" autocomplete="off">
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <button type="submit" class="btn btn-primary" name="button" id="btnUpdateEmployer" value="btnUpdateEmployer" onclick="displayMessage();">Update</button>
            </div>
            <div class="form-group col-md-4">
